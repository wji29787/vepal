               ...
               <el-dialog
                  ...
                  <el-container direction="vertical">
                    <el-row  class = "sl-row-item" :gutter = 20
                      >
                        <el-col class="edit-item-label" :span = "4">套装名称:</el-col>
                        <el-col  :span = "20"><el-input size="small" v-model="projectEdit.projectName"></el-input></el-col>
                    </el-row>
                      <el-row  class = "sl-row-item" :gutter = 20
                      >
                        <el-col class="edit-item-label" :span = "4">日期:</el-col>
                        <el-col :span = "20">
                          <el-date-picker
                            type="date"
                            placeholder="选择日期"
                      ...
                      <el-row  class = "sl-row-item" :gutter = 20
                      >
                        <el-col class="edit-item-label" :span = "4">描述:</el-col>
                        <el-col  :span = "20">
                          <el-input
                            type="textarea"
                    ...
                    <el-row class = "sl-row-item" :gutter = 20>
                       <el-col class="edit-item-label" :span = "4">关联:</el-col>
